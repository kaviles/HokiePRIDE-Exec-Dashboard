...
function handleRequestData($requestData) {
    ...
    if ($stringsLength < 4) {
        ...
        return searchRequestPublic($strings);
    }
    else {
...
*/
function searchRequestPublic($strings) {
    ...
    if ($mysqli) {
        ...
        for ($i = 0; $i < $limit; $i++) {
            ...
            $qs->bind_param("ssssssssssss", $string_w, $string_w, $string_w, $string, $string, 
                $string, $string, $string_w, $string_w, $string, 
                $string, $string);
            ...
            if ($qs_num_rows > 0) {
                ...
                for($j = 0; $qs->fetch(); $j++) {
                    ...
                    '", "loc":"'.$r_loc.'", "dcc":"'.$r_dcc.'", "covurl":"'.$r_covurl.
                    '", "comms":"'.$r_comms.'", "tags":"'.$r_tags.
                    '", "libid":"'.$r_libid.'", "status":"'.$r_status.'"}';
                }
            }
        }
